function [tau1, tau2, x, psi, t, Q] = BFGS(tau1_0, tau2_0, h0, u0, M, Rad, I, g, l, a_max, x0, k, xf)
...
Qx = q_cost_BB(h0, tau1, tau2, u0, M, Rad, I, g, l, a_max, x0, k);
R = 1;
...
disp('step2');
    [gradQ, x, psi, t, Q] = gradient(tau1, tau2, h0, u0, M, Rad, I, g, l, a_max, x0, xf, k);
    if gradQ'*gradQ <= ep1, 
        break;
    end
